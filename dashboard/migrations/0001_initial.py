# Generated by Django 2.2.12 on 2021-09-11 11:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=254)),
                ('role', models.CharField(choices=[('Barber', 'Barber'), ('Stylist', 'Stylist')], max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_purchase', models.DateTimeField(auto_created=True, null=True)),
